    ...
    <div class="page-content">
        <div class="card">
            <div class="d-flex justify-content-between">
                ...
                <a href="<?php echo e(route('admin.new.user')); ?>" class="btn-primary-fill">Create New User</a>
                <?php endif; ?>
            </div>
                ...
                <table class="table table-striped table-hover">
                    ...
                    <?php $__currentLoopData = $userList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td><?php echo e($user->refer_by); ?></td>

                            <?php if (\Illuminate\Support\Facades\Blade::check('hasrole', 'super-admin')): ?>
                            <td>
                                <?php if($user->has_medical_permission): ?>
                                    <span class="badge bg-success">Medical</span>
                                <?php endif; ?>
                                <?php if($user->has_slip_permission): ?>
                                    <span class="badge bg-success">Slip</span>
                                <?php endif; ?>
                                <?php if($user->has_link_permission): ?>
                                    <span class="badge bg-success">Link</span>
                                <?php endif; ?>
                            </td>
                            <td class="balance-td">
                                <p>MB: <?php echo e($user->balance); ?></p>
                                <p>SB: <?php echo e($user->slip_balance); ?></p>
                                <p class="text-primary">
                                    <strong class="text-primary">SN:</strong>
                                    <?php echo e($user->slip_logs_sum_slip_amount ?? 0); ?>
                            ...
                            <td class="btn-set">
                                <a href="javascript:void(0)" data-href="<?php echo e(route('admin.user.ban', $user->id)); ?>"
                                   class="ban-unban-btn <?php echo e($user->banned ? 'btn-primary-fill' : 'btn-warning-fill'); ?>">
                                    <?php echo e($user->banned ? 'Unban' : 'Ban'); ?> Customer
                                </a>
                                <a href="javascript:void(0)" data-href="<?php echo e(route('admin.user.delete')); ?>"
                                ...
                                <a href="javascript:void(0)" class="btn-permission btn-secondary-fill"
                                   ...
                                   data-has_medical_permission="<?php echo e($user->has_medical_permission ? 1 : 0); ?>"
                                   data-has_slip_permission="<?php echo e($user->has_slip_permission ? 1 : 0); ?>"
                                   data-has_link_permission="<?php echo e($user->has_link_permission ? 1 : 0); ?>"
                                >
                                ...
                                <a href="javascript:void(0)" class="btn-slip-permission btn btn-primary"
                                   ...
                                   data-running-slip-number="<?php echo e(current($user->slipLogs) ? $user->slipLogs[0]->slip_amount : 0); ?>"
                                   data-running-slip-amount="<?php echo e(current($user->slipLogs) ? $user->slipLogs[0]->amount : 0); ?>"
                                   data-running-slip-note="<?php echo e(current($user->slipLogs) ? $user->slipLogs[0]->note : ''); ?>">
            ...
            <script>
                $(document).ready(function () {
                    ...
                    $(document).on('click', '#score-modal button[type="submit"]', function (e) {
                        ...
                        $.ajax({
                            url: '<?php echo e(route('admin.user.balance.update')); ?>',
                            method: 'POST',
                            data: {
                                id: id,
                                balance: balance,
                    ...
                    $(document).on('click', '.pdf-generate-btn', function () {
                        ...
                        window.location.href = `<?php echo e(route('admin.user.pdf.generate')); ?>?id=${id}&start_date=${start_date}&end_date=${end_date}`;
                    });
                    ...
                    $(document).on('submit', '#slip-amount-permission-modal form', function (e) {
                        ...
                        $.ajax({
                            url: `<?php echo e(route('admin.user.Slip.amount.update')); ?>`,
                            method: 'POST',
                            data: {
                                _token: '<?php echo e(csrf_token()); ?>',
                                id: id,
                    ...
                    $(document).on('click', '#permission-modal button[type="submit"]', function (e) {
                        ...
                        $.ajax({
                            url: `<?php echo e(route('admin.user.permission.update')); ?>`,
                            method: 'POST',
                            data: {
                                _token: '<?php echo e(csrf_token()); ?>',
                                id: id,
...
<?php echo $__env->make('admin.layout.user-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Herd\marjsafin\resources\views/admin/user-list.blade.php ENDPATH**/ ?>