...
<div id="layout-wrapper">
    <main>
        ...
        <div class="login-area login-bg" style="background: url('<?php echo e(asset('assets/images/background.jpeg')); ?>'); background-size: contain; background-position: center center; background-repeat: no-repeat">
                    ...
                    <div class="offset-lg-1 rtl-offset-lg-1 col-xxl-3 col-xl-5 col-lg-6 col-md-8 col-sm-10">
                        <div class="login-card">
                            ...
                            <div class="logo logo-large mb-40">
                                <a href="<?php echo e(url('/')); ?>" class="mb-30 d-block">
                                    <img style="width: 60px" src="<?php echo e(customAsset('assets/images/profile.png')); ?>" alt="logo">
                                </a>
...
<?php /**PATH C:\Herd\marjsafin\resources\views/welcome.blade.php ENDPATH**/ ?>