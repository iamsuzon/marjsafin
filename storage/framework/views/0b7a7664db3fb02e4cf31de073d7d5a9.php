...
<?php $__env->startSection('contents'); ?>
    <div class="page-content">
        <div class="container-fluid">
            <?php if (\Illuminate\Support\Facades\Blade::check('role', 'super-admin|sub-admin')): ?>
                    ...
                    <div class="col-12">
                        <h2 class="manage__title">
                            ...
                            <?php if($start_date && $end_date): ?>
                                <span class="text-capitalize">(<?php echo e($start_date); ?> <i class="ri-arrow-right-line"></i> <?php echo e($end_date); ?>)</span>
                            <?php endif; ?>
                        </h2>
                        ...
                        <table class="table-color-col table-head-border table-td-border">
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $applicationList ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <?php if (\Illuminate\Support\Facades\Blade::check('role', 'analyst')): ?>
                                    <?php if(in_array(strtolower($item->center_name), ['altaskhis_markaz', 'yadan_medical', 'malancha_medical', 'kent_medical'])): ?>
                                        <?php continue; ?>
                                    <?php endif; ?>
                                <?php endif; ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <p><?php echo e($item->given_name); ?> <?php echo e($item->surname); ?></p>
                                        <p>NID: <?php echo e($item->nid_no); ?></p>
                                    </td>
                                    <?php if (\Illuminate\Support\Facades\Blade::check('hasrole', 'super-admin')): ?>
                                        <td>
                                            <p><?php echo e($item->ref_ledger); ?></p>
                                            <p>User: <?php echo e($item->user->username); ?>, Ref: <?php echo e($item->ref_no); ?></p>
                                        </td>
                                    <?php endif; ?>
                                    <td>
                                        <p class="text-capitalize"><?php echo e($item->gender); ?></p>
                                    ...
                                    <?php if (\Illuminate\Support\Facades\Blade::check('hasrole', 'super-admin')): ?>
                                        <td>
                                            <?php if($item->applicationPayment?->admin_amount > 0): ?>
                                                <p>Score: <?php echo e($item->applicationPayment?->admin_amount); ?></p>
                                            <?php endif; ?>

                                            <?php if($item->applicationPayment?->discount_amount > 0): ?>
                                                <p>Discount: <?php echo e($item->applicationPayment?->discount_amount); ?></p>
                                            <?php endif; ?>
                                        </td>
                                    <?php endif; ?>
                                    <td>
                                        ...
                                        ]); ?>"><?php echo e(getHealthConditionsName($item->health_status)); ?></p>
                                        <p>C: <?php echo e($item->health_status_details); ?></p>

                                        <?php if (\Illuminate\Support\Facades\Blade::check('hasrole', 'super-admin')): ?>
                                            <p>A: <?php echo e($item->applicationCustomComment?->health_condition); ?></p>
                                        <?php endif; ?>
                                    </td>
                                    ...
                                    <?php if (\Illuminate\Support\Facades\Blade::check('hasrole', 'super-admin')): ?>
                                        ...
                                        <td>
                                            <p class="badge bg-<?php echo e($class); ?>"><?php echo e($item->medical_status); ?></p>
                                        </td>
                                    <?php endif; ?>

                                    <?php if (\Illuminate\Support\Facades\Blade::check('hasanyrole', 'super-admin|admin')): ?>
                                    <td class="text-end px-15 d-flex gap-10">
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('modify-application')): ?>
                                            <a class="edit-btn" href="javascript:void(0)"
                                               data-id="<?php echo e($item->id); ?>"
                                               data-health_status="<?php echo e($item->health_status); ?>"
                                               data-health_status_details="<?php echo e($item->applicationCustomComment?->health_condition ?? $item->health_status_details); ?>"
                                               data-application_admin_payment="<?php echo e($item->applicationPayment?->admin_amount ?? ''); ?>"
                                               data-application_admin_discount="<?php echo e($item->applicationPayment?->discount_amount ?? ''); ?>"
                                        ...
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update-application')): ?>
                                                <a class="application_update_btn download-btn" href="javascript:void(0)" data-bs-target="#application-update-modal" data-bs-toggle="modal"
                                                    data-id="<?php echo e($item->id); ?>" data-passport="<?php echo e($item->passport_number); ?>" data-registarion="<?php echo e($item->serial_number); ?>" data-medical="<?php echo e($item->medical_date); ?>"
                                                >
                                                    <i class="ri-calendar-schedule-fill"></i>
                                                </a>

                                            <a class="view-btn" href="<?php echo e(route('admin.application.edit', $item->id)); ?>">
                                                <i class="ri-pencil-fill"></i>
                                            </a>
                                        <?php endif; ?>

                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete-application')): ?>
                        ...
                        <div class="row g-10">
                            ...
                            <div class="col-md-12">
                                <div class="contact-form">
                                    ...
                                    <input class="form-control input" type="number" name="application_admin_payment">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="contact-form">
                                    <label class="contact-label">Discount</label>
                                    <input class="form-control input" type="number" name="application_admin_discount">
                                </div>
                            </div>
                        </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $(document).on('submit', '#application-update-modal form', function (e) {
                ...
                $.ajax({
                    url: `<?php echo e(route('admin.application.update.reg-date')); ?>`,
                    type: 'POST',
                    data: {
            ...
            $(document).on('click', '.edit-btn', function () {
                ...
                let application_admin_discount = el.data('application_admin_discount');
                ...
                from.find('input[name="application_admin_discount"]').val('');
                ...
                if (allNull)
                {
                    ...
                    from.find('input[name="application_admin_discount"]').attr('disabled', true);
                    ...
                    from.find('input[name="application_admin_discount"]').attr('disabled', false);
                    ...
                    from.find('input[name="application_admin_discount"]').val(application_admin_discount);
                }
            ...
            $(document).on('click', '#edit-form button[type=submit]', function (e) {
                ...
                let application_admin_discount = form.find(`input[name="application_admin_discount"]`).val();
                ...
                axios.post(`<?php echo e(route('admin.application.result.update')); ?>?id=${id}`, {
                    ...
                    application_admin_discount: application_admin_discount,
                })
                    .then(res => {
                        let data = res.data;
...
<?php echo $__env->make('admin.layout.user-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Herd\marjsafin\resources\views/admin/application-list.blade.php ENDPATH**/ ?>