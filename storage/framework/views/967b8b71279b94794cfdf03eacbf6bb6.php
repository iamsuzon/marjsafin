...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.page-tabs','data' => ['title' => 'Card Management','links' => [
                [
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Card Management','links' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([
                [
                    'name' => 'Book Appointment Link List',
                    'route' => route('user.appointment.booking.list'),
                    'active' => false,
