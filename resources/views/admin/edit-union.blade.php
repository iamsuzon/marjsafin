...
@section('contents')
    <div class="page-content">
        <div class="card">
            ...
            <form action="{{route('admin.edit.union-accounts', $account->id)}}" method="POST" id="union-registration-form">
                @csrf
                ...
                <div class="row g-16 mt-25">
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                        <div class="contact-form">
                            ...
                            <input class="form-control input" type="text" name="name" placeholder="Name" value="{{$account->name}}">
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                        <div class="contact-form">
                            <label class="contact-label">Username <span class="fillable mx-1">*</span></label>
                            <input class="form-control input" type="text" name="username" placeholder="Username" value="{{$account->username}}">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                        <div class="contact-form">
                            ...
                            <input class="form-control input" type="text" name="email" placeholder="Email address" value="{{$account->email}}">
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                        <div class="contact-form">
