                        ...
                        <div class="col-lg-12">
                            <div class="hero-padding position-relative z-index-5">
                                <div class="welcome-card">
                                    <img class="position-absolute img-1 img-fluid" src="{{customAsset('assets/images/icon/hero-icon1.png')}}"
                                         alt="">
                                    <img class="position-absolute img-2 img-fluid" src="{{customAsset('assets/images/icon/hero-icon2.png')}}"
                                         alt="">
                                    <img class="position-absolute img-3 img-fluid" src="{{customAsset('assets/images/icon/hero-icon3.png')}}"
                                         alt="">
                                    <img class="position-absolute img-4 img-fluid" src="{{customAsset('assets/images/icon/hero-icon4.png')}}"
                                         alt="">
                                    <img class="position-absolute img-5 img-fluid" src="{{customAsset('assets/images/icon/hero-icon5.png')}}"
                                         alt="">
                                    <img class="position-absolute img-5 img-fluid" src="{{customAsset('assets/images/icon/hero-icon6.png')}}"
                                         alt="">
                                </div>
