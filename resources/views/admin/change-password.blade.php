    ...
    <div class="page-content">
        <div class="container-fluid">
            <div class="card">
                <div class="row">
                    <div class="col-12">
                        <h2 class="manage__title">Change Password</h2>
                        ...
                        <form action="{{route('admin.change.password')}}" method="POST" id="search-form">
                            @csrf
                            ...
                            <div class="row d-flex justify-content-center mt-25">
                                ...
                                <div class="col-md-12 d-flex align-items-end justify-content-end mt-20">
                                    <div class="contact-form d-flex gap-10">
                                        <button class="btn-primary-fill search_btn_passport" type="submit">Change</button>
