                    ...
                    <div class="col-12">
                        ...
                        @if(session('success'))
                            <div class="alert alert-success alert-dismissible fade show" role="alert">
                                <strong>Success!</strong> {{ session('success') }} To view the details <a
                                    class="text-primary fw-bold" href="{{route('admin.application.list')}}">click
                                    here</a>
                        ...
                        <form action="{{route('admin.application.edit', $application->id)}}" method="POST"
                            ...
                            <div class="row g-16">
                                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                                    <div class="contact-form">
                                        <label class="contact-label">Passport Number <span
                                                class="fillable mx-1">*</span></label>
                                        <input class="form-control input" type="text" name="passport_number"
                                               placeholder="Passport Number" value="{{$application->passport_number}}">
                                    </div>
                                </div>
                                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                                    <div class="contact-form">
                                        ...
                                        <select class="select2" name="gender">
                                            ...
                                            <option
                                                {{$application->gender === 'female' ? 'selected' : ''}} value="female">
                                                Female
                                            </option>
                                            <option
                                                {{$application->gender === 'other' ? 'selected' : ''}} value="other">
                                                Other
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                                    <div class="contact-form">
                                        <label class="contact-label">Traveling To<span
                                                class="fillable mx-1">*</span></label>
                                        <select class="select2" name="traveling_to">
                                            <option value="" selected disabled>Select an option</option>
                                            @foreach(countryList() ?? [] as $index => $country)
                                                <option
                                                    {{$application->traveling_to === $index ? 'selected' : ''}} value="{{ $index }}">{{ $country }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                                    <div class="contact-form">
                                        ...
                                        <select class="select2" name="marital_status">
                                            <option value="" selected disabled>Select an option</option>
                                            <option
                                                {{$application->marital_status === 'unmarried' ? 'selected' : ''}} value="unmarried">
                                                Unmarried
                                            </option>
                                            <option
                                                {{$application->marital_status === 'married' ? 'selected' : ''}} value="married">
                                                Married
                                            </option>
                                            <option
                                                {{$application->marital_status === 'other' ? 'selected' : ''}} value="other">
                                                Other
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                                    <div class="contact-form">
                                        <label class="contact-label">Center Name<span
                                                class="fillable mx-1">*</span></label>
                                        <select class="select2" name="center_name">
                                            ...
                                            @foreach(centerList() ?? [] as $index => $center)
                                                ...
                                                @endphp
                                                <option
                                                    {{$application->center_name === $index ? 'selected' : ''}} value="{{ $index }}">{{ $center }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                                    <div class="contact-form">
                                        <label class="contact-label">Surname <span
                                                class="fillable mx-1">*</span></label>
                                        <input class="form-control input" type="text" name="surname"
                                               placeholder="Surname" value="{{$application->surname}}">
                                    </div>
                                </div>
                                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                                    <div class="contact-form">
                                        <label class="contact-label">Given Name <span
                                                class="fillable mx-1">*</span></label>
                                        <input class="form-control input" type="text" name="given_name"
                                               placeholder="Given Name" value="{{$application->given_name}}">
                                    </div>
                                </div>
                                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                                    <div class="contact-form">
                                        <label class="contact-label">Father Name</label>
                                        <input class="form-control input" type="text" name="father_name"
                                               placeholder="Father Name" value="{{$application->father_name}}">
                                    </div>
                                </div>
                                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                                    <div class="contact-form">
                                        <label class="contact-label">Mother Name</label>
                                        <input class="form-control input" type="text" name="mother_name"
                                               placeholder="Mother Name" value="{{$application->mother_name}}">
                                    </div>
                                </div>
                                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                                    <div class="contact-form">
                                        ...
                                        <select class="select2" name="religion">
                                            ...
                                            @foreach(religionList() ?? [] as $index => $religion)
                                                <option
                                                    {{$application->religion === $index ? 'selected' : ''}} value="{{ $index }}">{{ $religion }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="contact-form">
                                        ...
                                        <select class="select2" name="pp_issue_place">
                                            ...
                                            @foreach(ppIssuePlaceList() ?? [] as $index => $ppIssuePlace)
                                                <option
                                                    {{$application->pp_issue_place === $index ? 'selected' : ''}} value="{{ $index }}">{{ $ppIssuePlace }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                                    <div class="contact-form">
                                        <label class="contact-label">Profession<span
                                                class="fillable mx-1">*</span></label>
                                        <select class="select2" name="profession">
                                            <option value="" selected disabled>Select an option</option>
                                            @foreach(ProfessionList() ?? [] as $index => $item)
                                                <option
                                                    {{$application->profession === $index ? 'selected' : ''}} value="{{ $index }}">{{ $item }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                                    <div class="contact-form">
                                        <label class="contact-label">Nationality<span
                                                class="fillable mx-1">*</span></label>
                                        <select class="select2" name="nationality">
                                            <option value="" selected disabled>Select an option</option>
                                            @foreach(nationality() ?? [] as $index => $item)
                                                <option
                                                    {{$application->nationality === $index ? 'selected' : ''}} value="{{ $index }}">{{ $item }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                                    <div class="contact-form">
                                        ...
                                        <input class="form-control input" type="number" name="nid_no"
                                               placeholder="NID Number" value="{{$application->nid_no}}">
                                    </div>
                                </div>
                                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                                    <div class="contact-form">
