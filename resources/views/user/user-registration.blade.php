                            ...
                            <div class="row g-16">
                                ...
                                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                                    <div class="contact-form">
                                        ...
                                        <input class="form-control input" type="text" name="surname" placeholder="Passport Number" value="{{old('surname')}}">
                                    </div>
                                </div>
                                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                                    <div class="contact-form">
                                        <label class="contact-label">Given Name <span class="fillable mx-1">*</span></label>
                                        <input class="form-control input" type="text" name="given_name" placeholder="Passport Number" value="{{old('given_name')}}">
                                    </div>
                                </div>
                                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                                    <div class="contact-form">
                                        <label class="contact-label">Father Name <span class="fillable mx-1">*</span></label>
                                        <input class="form-control input" type="text" name="father_name" placeholder="Passport Number" value="{{old('father_name')}}">
                                    </div>
                                </div>
                                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                                    <div class="contact-form">
                                        <label class="contact-label">Mother Name <span class="fillable mx-1">*</span></label>
                                        <input class="form-control input" type="text" name="mother_name" placeholder="Passport Number" value="{{old('mother_name')}}">
                                    </div>
                                </div>
                                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                                    <div class="contact-form">
                                ...
                                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                                    <div class="contact-form">
                                        ...
                                        <input class="form-control input" type="number" name="nid_no" placeholder="Passport Number" value="{{old('nid_no')}}">
                                    </div>
                                </div>
                                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                                    <div class="contact-form">
                                ...
                                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                                    <div class="contact-form">
                                        ...
                                        <input class="form-control input" type="text" name="ref_no" placeholder="Passport Number" value="{{old('ref_no')}}">
                                    </div>
                                </div>
                            </div>
