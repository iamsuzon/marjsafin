...
@section('title', 'Book Appointment Edit')
    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="row">
                    <div class="col-12">
                        <h2 class="manage__title mb-25">Appointment Booking - Edit</h2>
                        ...
                        <form action="{{route('user.appointment.booking.edit.registration', $bookingItem->passport_number)}}" method="POST" id="link-registration-form">
                            @csrf

                            <input type="hidden" name="id" value="{{ $bookingItem->id }}">
                            ...
                            <div class="row g-16">
                                    ...
                                    <div class="contact-form">
                                        ...
                                        <select class="form-control" name="type">
                                            ...
                                            @foreach($booking_types ?? [] as $index => $type)
                                                <option value="{{ $index }}" {{ $bookingItem->type === $index ? 'selected' : '' }}>{{ $type }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
                                    <div class="contact-form">
                                        ...
                                        <input class="form-control input" type="text" name="reference" placeholder="Reference Name" value="{{$bookingItem->reference}}">
                                    </div>
                                </div>
                                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
                                    <div class="contact-form">
                                    ...
                                    <div class="contact-form">
                                        ...
                                        <select class="form-control" name="country_traveling_to">
                                            ...
                                            @foreach($traveling_country ?? [] as $index => $tc)
                                                <option value="{{ $index }}" {{ $bookingItem->country_traveling_to === $index ? 'selected' : '' }}>{{ $tc }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
                                    <div class="contact-form">
                                        ...
                                        <input class="form-control input" type="text" name="first_name" placeholder="First Name" value="{{ $bookingItem->first_name }}">
                                    </div>
                                </div>
                                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
                                    <div class="contact-form">
                                        <label class="contact-label">Last Name <span class="fillable mx-1">*</span></label>
                                        <input class="form-control input" type="text" name="last_name" placeholder="Last Name" value="{{ $bookingItem->last_name }}">
                                    </div>
                                </div>
                                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
                                    <div class="contact-form">
                                    ...
                                    <div class="contact-form">
                                        ...
                                        <select class="form-control" name="gender">
                                            ...
                                            @foreach($gender as $index => $item)
                                                <option value="{{ $index }}" {{ $bookingItem->gender === $index ? 'selected' : '' }}>{{ $item }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="contact-form">
                                        ...
                                        <select class="form-control" name="marital_status">
                                            ...
                                            @foreach($marital_status as $index => $item)
                                                <option value="{{ $index }}" {{ $bookingItem->marital_status === $index ? 'selected' : '' }}>{{ $item }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
                                    <div class="contact-form">
                                        ...
                                        <input class="form-control input" type="text" name="passport_number" id="passport_number" placeholder="Passport Number" value="{{$bookingItem->passport_number}}">
                                    </div>
                                </div>
                                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
                                    <div class="contact-form">
                                        <label class="contact-label">Confirm Passport Number <span class="fillable mx-1">*</span></label>
                                        <input class="form-control input" type="text" name="confirm_passport_number" id="confirm_passport_number" placeholder="Confirm Passport Number" value="{{$bookingItem->passport_number}}">
                                    </div>
                                </div>
                                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
                                    <div class="contact-form">
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
                                    <div class="contact-form">
                                        ...
                                        <input class="form-control input" type="text" name="passport_issue_place" placeholder="Passport Issue Place" value="{{ $bookingItem->passport_issue_place }}">
                                    </div>
                                </div>
                                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
                                    <div class="contact-form">
                                        ...
                                        <select class="form-control" name="passport_expiry_date">
                                            ...
                                            @foreach([5,10] as $year)
                                                <option value="{{ $year }}" {{ $year === (int) $bookingItem->passport_expire_validity ? 'selected' : '' }}>{{ $year }} Years</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="contact-form">
                                        ...
                                        <select class="form-control" name="visa_type">
                                            ...
                                            @foreach($visa_type ?? [] as $index => $value)
                                                <option {{$bookingItem->visa_type === $index ? 'selected' : ''}} value="{{ $index }}">{{ $value }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
                                    <div class="contact-form">
                                        ...
                                        <input class="form-control input" type="text" name="nid_number" placeholder="Your NID Number" value="{{ $bookingItem->nid_number }}">
                                    </div>
                                </div>
                                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
                                    <div class="contact-form">
                            ...
                            <div class="row g-16 mt-25">
                                <div class="contact-form d-flex justify-content-end gap-10">
                                    ...
                                    <button class="btn-primary-fill" type="submit">Update And Continue</button>
                                </div>
                            </div>
                        </form>
                    </div>
...
@section('scripts')
    <script>
        $(document).ready(function () {
            ...
            $('select[name=applied_position]').select2();
            $('select[name=applied_position]').val(`{{ $bookingItem->applied_position }}`).trigger('change');
